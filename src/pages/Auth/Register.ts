...
export const Register = (): string => {
  ...
  return /*html*/ `
    <div class="h-screen w-screen flex items-center justify-center bg-sm-white dark:bg-sm-black">
        ...
        <form class="flex flex-col gap-4 bg-white p-10 rounded-md shadow-md dark:bg-sm-black-light max-lg:p-6" id="register_form">
            ...
            <input type="password" placeholder="retype password" class="px-3 py-1 border border-sm-gray rounded-md text-2xl user-invalid:border-red-500 dark:text-white max-lg:text-xl" required>
            <button class="bg-sm-purple text-white p-1 text-2xl rounded-md max-lg:text-xl">Register</button>
