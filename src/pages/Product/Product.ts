            ...
            <section class="pt-32 max-2xl:pt-48">
                ...
                <div id="product_section" class="flex items-center justify-center gap-30 max-xl:flex-col max-xl:gap-10">
                    ...
                    <div>
                        ...
                        <p class="max-w-[400px] mt-3 max-2xl:text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores tempora corrupti consectetur, et illum animi a autem repellat repudiandae</p>
