...
export const Products = (): string => {
  ...
  return /*html*/ `
    <div class="w-full h-full relative bg-sm-white dark:bg-sm-black overflow-y-scroll">
        <div class="grid grid-cols-5 gap-6 p-8 justify-items-center overflow-x-hidden max-2xl:grid-cols-3 max-xl:grid-cols-2 max-md:flex max-md:flex-col max-md:items-center" id="admin_dashboard_products_wrapper">
